...
Essa versão da api utiliza o banco de dados mongodb rodando em um container docker, dessa forma, será necessário que você tenha o docker instalado em sua máquina. 
### Passos iniciais
